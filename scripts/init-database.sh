#!/bin/bash
# Script: Inicializar base de datos SQLite con schema constitucional
# Ref: BLUEPRINT_ARQUITECTURA.md - Schema SQL

set -e

echo "🗄️  Inicializando base de datos SQLite..."

cd vouchers-hostal-playa-norte/backend/db
...
echo "✅ Schema SQL creado: backend/db/schema.sql"
